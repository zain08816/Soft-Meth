 ...
 */
public class Allaire extends AppCompatActivity {
    private final double SALES_TAX = 0.06625;
    private final int STUDENT_PRICE = 20;
    private final int SENIOR_PRICE = 20;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        location.setText(getString(R.string.allaire_loc));
        desc.setText(getString(R.string.allaire_desc));
        image.setImageResource(R.drawable.allaire);
        image.setOnClickListener(v -> {
            Uri uri = Uri.parse(getString(R.string.allaire_site));
